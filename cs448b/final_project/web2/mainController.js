...
cs142App.controller('MainController', ['$scope', function($scope) {
   ...
   $scope.main.motto = 'I come before you as an author only';

   $scope.main.displayStates = true; // false = display example view

   $scope.main.toggleDisplay = function() {
   	$scope.main.displayStates = !$scope.main.displayStates;
   };
}]);
